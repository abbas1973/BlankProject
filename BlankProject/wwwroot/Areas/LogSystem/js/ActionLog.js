...
breadcrumb.push({ title: "لاگ فعالیت کاربران", link: "#" });




// عملیات مربوط به مدیریت لاگ فعالیت ها
var _area = "logsystem";
var _controller = "actionlogs";
var entity = {
        ...
        initial: function () {
            this.table = $('#datatables').DataTable({
                ...
                "columns": [
                    ...
                    { "data": "actionName", "name": "نوع فعالیت" },
                    { "data": "menuName", "name": "حوزه" },
                    { "data": "targetId", "name": "شناسه" },
...
var filter = {
    initial: _ => {
        ...
        filter.actions.initial();
        filter.menus.initial();
    ...
    collect: _ => {
        var data = {
            ...
            UserIp: $("#FilterUserIp").val(),
            ActionType: $("#FilterActionType").val(),
            MenuType: $("#FilterMenuType").val(),
    ...
    actions: {
        initial: _ => {
            ...
            $('#FilterActionType option[value="12"]').remove();
            $('#FilterActionType option[value="13"]').remove();
        }
    },
    ...
    menus: {
        initial: _ => {
            ...
            $('#FilterMenuType option[value="0"]').remove();
        }
    },
